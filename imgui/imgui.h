...
enum ImGuiColorEditFlags_
{
	...
	ImGuiColorEditFlags_NoSidePreview = 1 << 8,   //              // ColorPicker: disable bigger color preview on right side of the picker, use small colored square preview instead.
												  ...
												  ImGuiColorEditFlags_HDR = 1 << 12,  //              // (WIP) ColorEdit: Currently only disable 0.0f..1.0f limits in ImColor edition (note: you probably want to use ImGuiColorEditFlags_Float flag as well).
...
struct ImColor
{
	...
	ImColor(ImU32 ImColor) { float sc = 1.0f / 255.0f; Value.x = (float)((ImColor >> IM_COL32_R_SHIFT) & 0xFF) * sc; Value.y = (float)((ImColor >> IM_COL32_G_SHIFT) & 0xFF) * sc; Value.z = (float)((ImColor >> IM_COL32_B_SHIFT) & 0xFF) * sc; Value.w = (float)((ImColor >> IM_COL32_A_SHIFT) & 0xFF) * sc; }
...
//  2. Call GetTexDataAsAlpha8() or GetTexDataAsImColor32() to build and retrieve pixels data.
...
struct ImFontAtlas
{
	...
	IMGUI_API void              Clear();                    // Clear all
															...
															// ImColor32 format is provided for convenience and compatibility, but note that unless you use CustomRect to draw color data, the RGB pixels emitted from Fonts will all be white (~75% of waste). 
															// Pitch = Width * BytesPerPixels
	IMGUI_API bool              Build();                    // Build pixels data. This is called automatically for you by the GetTexData*** functions.
	IMGUI_API void              GetTexDataAsAlpha8(unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel = NULL);  // 1 byte per-pixel
	IMGUI_API void              GetTexDataAsImColor32(unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel = NULL);  // 4 bytes-per-pixel
	...
	unsigned int*               TexPixelsImColor32;    // 4 component per pixel, each component is unsigned 8-bit. Total size = TexWidth * TexHeight * 4
...
// ImFontAtlas automatically loads a default embedded font for you when you call GetTexDataAsAlpha8() or GetTexDataAsImColor32().
struct ImFont
{
